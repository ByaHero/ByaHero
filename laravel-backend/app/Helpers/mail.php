...
if (!defined('BREVO_API_KEY')) {
    define('BREVO_API_KEY', env('BREVO_API_KEY', 'YOUR_BREVO_API_KEY_HERE'));
}
if (!defined('SENDER_EMAIL')) {
    define('SENDER_EMAIL', env('SENDER_EMAIL', 'no-reply@byahero.com'));
}
if (!defined('SENDER_NAME')) {
    define('SENDER_NAME', env('SENDER_NAME', 'ByaHero Support'));
}
