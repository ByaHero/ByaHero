...
<div class="container" style="max-width:520px; margin-top:72px;">
  ...
  <div class="row">
    <div class="col-12">
      <div class="fw-bold" style="color:#123e6c; font-size:18px; line-height:1.2;">
        Emergency Contact
      </div>
    </div>
  </div>
      ...
      <div class="card border-0 shadow-sm" style="border-radius:14px;">
        <div class="card-body d-flex align-items-center gap-3" style="padding:14px;">
          <div class="d-flex align-items-center justify-content-center flex-shrink-0"
               style="width:56px;height:56px;border-radius:999px;background:#ff7aa2;">
          ...
          <div class="flex-grow-1">
            <div class="fw-bold" style="font-size:16px;">Ate</div>
