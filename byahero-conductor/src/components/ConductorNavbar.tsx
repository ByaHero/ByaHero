          ...
          <Animated.View style={[tw`bg-[#f3f4f6] h-full shadow-lg`, { width: width * 0.85, transform: [{ translateX: slideAnim }] }]}>
            ...
            <View style={tw`p-4 gap-3`}>
              ...
              <TouchableOpacity
                ...
                onPress={() => { 
                  closeMenu(); 
                  router.push('/showGuide');
                }}
              >
                <View style={tw`w-9 h-9 items-center justify-center mr-2 ml-2`}>
                  <Image source={require('../../assets/images/USER GUIDE.svg')} style={tw`w-7 h-7`} contentFit="contain" />
                </View>
                <Text style={tw`text-[#111827] font-extrabold text-base`}>Conductor Guide</Text>
              </TouchableOpacity>
