...
import { WaitingStatusModal } from '../../components/passenger-dashboard/WaitingStatusModal';
import { BoardingPromptModal } from '../../components/passenger-dashboard/BoardingPromptModal';
import { DepartingPromptModal } from '../../components/passenger-dashboard/DepartingPromptModal';
    ...
    <SafeAreaView style={tw`flex-1 bg-white`}>
      ...
      <View style={tw`flex-1 relative`}>
        ...
        <WaitingStatusModal
          ...
          nearestStopName={resolveNearestStop()?.name || null}
