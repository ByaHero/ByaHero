  ...
  return `
    ...
    <body>
      ...
      <script>
        ...
        // Route lines disabled to make the map plain as requested
        /*
          ...
          try {
            ...
            if (data.type === 'SET_CENTER') {
              ...
              data.stops.forEach(function(stop) {
                ...
                if (lat && lng) {
                  var typeUpper = (stop.type || 'stop').toUpperCase();
                  var isBusStop = typeUpper === 'TERMINAL' || typeUpper === 'BUS_STOP';
                  var labelType = isBusStop ? 'Bus Stop' : 'Pickup Point';
                  var fillColor = isBusStop ? '#ef4444' : '#1856b0';
